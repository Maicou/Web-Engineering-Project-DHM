...
function OwnerFunction(){
    $conn = Database::connect();
    $owner="Owner-Eintrag noch nicht aus DB ausgelesen";
    try {
        
        // set the PDO error mode to exception
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    //$stmt = $conn->prepare("SELECT description FROM `building` WHERE id='1'");
    $stmt = "SELECT * FROM `owner` WHERE id='1'";
    //$stmt->execute();
    $owner="leer";
    foreach ($conn->query($stmt) as $row){
    $owner = $row['ownername'];
...
// Namen
$pdf->Cell(80, 5, utf8_decode(TenantName($tenantId)), 0, 0, "L", 1);   
...
// Strasse
$pdf->Cell(80, 5, utf8_decode(TenantStreet($tenantId)), 0, 0, "L", 1);   
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, utf8_decode("Anton-Leo-Strasse 6"), 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch

// Postleitzahl + Stadt
$pdf->Cell(80, 5, utf8_decode(TenantPCandPlace($tenantId)), 0, 0, "L", 1);   
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, utf8_decode("79713 Bad Säckingen"), 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch
...
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, utf8_decode("Telefonnummer: XXXXXXX"), 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch
...
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, utf8_decode("Email: XXXXX@YYYYY.ch"), 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch
$pdf->Ln();

// Rechnungs-Titel
$pdf->SetFont("Helvetica", "b", 17);
$pdf->Cell(80, 5, utf8_decode("Rechnung"), 0, 0, "L", 1);   
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, "", 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch
$pdf->Ln();

// Rechnungs-Header
$pdf->SetFont("Helvetica", "b", 11);
$pdf->Cell(50, 5, utf8_decode("Rechnung Nr. ".$incomingId), 0, 0, "L", 1);   
$pdf->Cell(45, 5, utf8_decode("Kunden-Nr.: ".$tenantId), 0, 0, "C", 1); 
$pdf->Cell(15, 5, "", 0, 0, "C", 1); 
$pdf->Cell(80, 5, utf8_decode("Datum: ".IncomeDate($incomingId)), 0, 0, "L", 1); 
$pdf->Ln();   //Zeilenumbruch
$pdf->Ln();
...
$pdf->Cell(70, 10, utf8_decode("Leistungsart"), "LTRB", 0, "C", 1);   
$pdf->Cell(45, 10, utf8_decode("Betrag exkl. MwSt."), "LTR", 0, "C", 1); 
$pdf->Cell(15, 10, utf8_decode("MwSt."), "LTR", 0, "C", 1); 
$pdf->Cell(60, 10, utf8_decode("Gesamtbetrag"), "LTR", 0, "C", 1); 
$pdf->Ln();   //Zeilenumbruch
